...
class MainController extends Controller
{
    ...
    public function PeadAlert($email)
    {
        $query = "WITH otz_10_19_yrs as (
            ...
            ), documented_viral_loads_last_6 as (
                select
                    distinct PatientIDHash,
                    SiteCode,
                    PatientPKHash
                from ODS.dbo.[Intermediate_OrderedViralLoads] 
                where OrderedbyDate between dateadd(m, -6, dateadd(day, 1, eomonth(getdate(), -1))) 
                -- subtract 6 months from last day of previous completed month                    
                and eomonth(dateadd(mm, -1, getdate())) 
                --get last day of previous completed month                    
                and TestResult is not null  
                ...
                ), txcurr_0_17_yrs_valid_vl_6_months as (                
                select                        
                    Cohort.SiteCode MFLCode,                        
                    FacilityName,                        
                    County,                        
                    PartnerName CTPartner,                        
                    count(*) as no_txcurr_0_17_yrs_valid_vl_6_months
                from REPORTING.dbo.Linelist_FACTART as cohort
                inner join documented_viral_loads_last_6 on documented_viral_loads_last_6.PatientIDHash Collate Latin1_General_CI_AS = cohort.PatientIDHash
                        and documented_viral_loads_last_6.PatientPKHash Collate Latin1_General_CI_AS = cohort.PatientPKHash
                        and documented_viral_loads_last_6.SiteCode = cohort.SiteCode
                where age between 0 and 17                    
                    and isTXCurr=1                
                group by Cohort.SiteCode, FacilityName, PartnerName, County
            ...
            select
                ...
                coalesce(txcurr_0_17_yrs_valid_vl_6_months.no_txcurr_0_17_yrs_valid_vl_6_months, 0) as no_txcurr_0_17_yrs_valid_vl_6_months,
            ...
            left join txcurr_0_17_yrs_valid_vl_6_months on txcurr_0_17_yrs_valid_vl_6_months.MFLCode = facility_partner_combinations.MFLCode
